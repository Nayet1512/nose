            ...
            <td>
                <h2>
                    <p align="justify">
                        ...
                        institución educativa que comparte la visión de que la educación dignifica a las personas y es
                        el motor del crecimiento económico y social. Fundado en 1991, se ha consolidado como una opción
                        educativa de calidad en el estado de México, brindando a los estudiantes una formación integral
                        que combina la teoría con la práctica.<br>
                        El equipo del CECyTEM encargado de realizar una página web está compuesto por estudiantes con
                        habilidades en áreas como:<br>
                        <strong>Desarrollo Web:</strong> Programadores y diseñadores que crean la estructura,
                        funcionalidad y diseño de la página.<br>
                        <strong>Contenido:</strong> Escritores y editores que generan el contenido informativo y
                        atractivo para la web.<br>
                        <strong>Diseño Gráfico:</strong> Diseñadores que crean los elementos visuales, logotipos y
                        gráficos.<br>
                        <strong>Gestión de Proyectos:</strong> Coordinadores que planifican y supervisan el proceso de
                        desarrollo.<br>
                        <strong>Experiencia de Usuario (UX):</strong> Especialistas que se aseguran de que la página sea
                        fácil de usar y atractiva para los visitantes.<br>
                        Este equipo trabajaría en conjunto para crear una página web que refleje la misión, visión y
                        valores del CECyTEM, así como su oferta educativa, logros y actividades.
                    </p>
                </h2>
            </td>
        </tr>
